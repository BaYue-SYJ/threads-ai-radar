...
(function (global) {
  ...
  zh: {
    ...
    'flt_min_inter': '最低互动',
    'flt_min_inter_title': '按点赞 / 回复 / 转发三项中的最高值判断，超过阈值才显示',
    'flt_sort': '排序',
    'btn_reset': '重置',
    'btn_export': '导出 CSV',
  ...
  en: {
    ...
    'flt_min_inter_title': 'Matched against the highest of likes, replies or reposts',
    'flt_sort': 'Sort',
    'btn_reset': 'Reset',
  ...
  'zh-TW': {
    ...
    'flt_min_inter': '最低互動',
    'flt_min_inter_title': '按讚 / 回覆 / 轉發三項中的最高值判斷，超過門檻才顯示',
    'flt_sort': '排序',
    'btn_reset': '重設',
    'btn_export': '匯出 CSV',
  ...
  ja: {
    ...
    'flt_min_inter_title': 'いいね・返信・リポストの最大値で判定し、閾値を超えた投稿だけ表示',
    'flt_sort': '並び順',
    'btn_reset': 'リセット',
    'btn_export': 'CSV 書き出し',
  ...
  ko: {
    ...
    'flt_min_inter_title': '좋아요 / 답글 / 리포스트 중 최댓값 기준, 임계값 초과만 표시',
    'flt_sort': '정렬',
    'btn_reset': '초기화',
    'btn_export': 'CSV 내보내기',
